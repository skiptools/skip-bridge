...
//        .library(name: "SkipBridgeSamples2", type: .dynamic, targets: ["SkipBridgeSamples2"]),
        .library(name: "SkipBridgeSamples3", type: .dynamic, targets: ["SkipBridgeSamples3"]),
    ],
    dependencies: [
    ...
    targets: [
        .target(name: "CJNI"),
        .target(name: "SkipJNI", dependencies: ["CJNI"]),
...
//            plugins: [.plugin(name: "skipstone", package: "skip")]),
        ...
        .target(name: "SkipBridgeSamples3",
            dependencies: ["SkipBridge2"],
            plugins: [.plugin(name: "skipstone", package: "skip")]),
...
//            plugins: [.plugin(name: "skipstone", package: "skip")]),
        ...
        .testTarget(name: "SkipBridgeSamples3Tests",
            dependencies: ["SkipBridgeSamples3", .product(name: "SkipTest", package: "skip")],
            plugins: [.plugin(name: "skipstone", package: "skip")]),
    ]
)
